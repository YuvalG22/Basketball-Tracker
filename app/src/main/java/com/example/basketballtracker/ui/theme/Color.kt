...
//Light Theme
val LightPrimary = Color(0xFFFF7A00)
val LightOnPrimary = Color(0xFFFFFFFF)

val LightPrimaryContainer = Color(0xFFFFE0C2)
val LightOnPrimaryContainer = Color(0xFF2B1500)
...
val LightSurfaceVariant = Color(0xFFE7E7E7)
